<x-filament-panels::page>
    ...
    <form class="w-full " wire:submit.prevent="search">
        <div class="flex justify-center items-center mb-6">
            ...
            <div class="mt-5 px-3">
                <button type="submit" class="bg-primary-500 text-white rounded px-4 py-3">جستجو</button>
            </div>
            <div class="mt-5 px-3">
                <button wire:click.prevent="approveSelect" type="button" class="bg-primary-500 text-white rounded px-4 py-3">تایید انتخابی</button>
            </div>
        </div>
    </form>
    @isset($this->harms)
