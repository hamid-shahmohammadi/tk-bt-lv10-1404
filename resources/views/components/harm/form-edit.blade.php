...
<form x-data="formHandler" wire:submit.prevent="editHarm">
    @if ($message)
    ...
    <div class="flex justify-end mt-10 ">
        ...
        <button type="submit"
            class="px-3 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-500 rounded-md dark:bg-blue-600 dark:hover:bg-primary-700 dark:focus:bg-primary-700 hover:bg-primary-600 focus:outline-none focus:bg-primary-500 focus:ring focus:ring-primary-300 focus:ring-opacity-50">
            ویرایش اطلاعات
        </button>
        <x-mary-button label="بستن" @click="$wire.editModalHarm = false" />
    </div>
</form>
